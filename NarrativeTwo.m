...
for i=1:n_draws
    ...
    if (S*Ldraws{i,1}*shock2 > 0 && Edraw(tt, :)*shock1 > 0 && ...
            abs(variable1*Ldraws{i,1}*shock1*Edraw(tt, :)*shock1) > ...
            abs(variable1*Ldraws{i,1}*shock2*Edraw(tt, :)*shock2) && ...
            abs(variable1*Ldraws{i,1}*shock1*Edraw(tt1, :)*shock1) > ...
            abs(variable1*Ldraws{i,1}*shock2*Edraw(tt1, :)*shock2))
